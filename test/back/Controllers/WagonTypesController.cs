...
public class WagonTypesController(ApplicationDbContext context) : BaseCrudController<WagonType, WagonTypeDto, CreateWagonTypeDto, UpdateWagonTypeDto>(context, "wagontypes")
{
