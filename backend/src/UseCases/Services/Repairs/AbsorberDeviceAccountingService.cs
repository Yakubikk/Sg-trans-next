...
{
    private readonly IBaseRepository<AbsorberDeviceAccounting> _accountingRepository;

    public AbsorberDeviceAccountingService(IAbsorberDeviceAccountingRepository accountingRepository)
    {
