...
public class PartStatusesController(ApplicationDbContext context) : BaseCrudController<PartStatus, PartStatusDto, CreatePartStatusDto, UpdatePartStatusDto>(context, "partstatuses")
{
