...
public static class PersistenceExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<BaseRepository<DepotReference>>();
        ...
        services.AddScoped<BaseRepository<PartReference>>();
        ...
        services.AddScoped<BaseRepository<RepairReference>>();
        services.AddScoped<BaseRepository<RepairTypeReference>>();
