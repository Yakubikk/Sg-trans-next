...
public class RepairTypesController(ApplicationDbContext context) : BaseCrudController<RepairType, RepairTypeDto, CreateRepairTypeDto, UpdateRepairTypeDto>(context, "repairtypes")
{
